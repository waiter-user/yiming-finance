...
import com.java.ymjr.core.hfb.FormHelper;
import com.java.ymjr.core.hfb.HfbConst;
...
import com.java.ymjr.core.mapper.UserBindMapper;
...
public class UserBindServiceImpl extends ServiceImpl<UserBindMapper, UserBind> implements UserBindService {
    ...
    public String commitBindUser(UserBindVO userBindVO, Long userId) {
        ...
        //抛异常
        if(null!=userBind){
            throw  new YmjrException(ResponseEnum.USER_BIND_IDCARD_EXIST_ERROR);
        }
        //查询用户绑定信息
    ...
    public void notify(Map<String, Object> paramMap) {
        ...
        //更新用户绑定表的bind_code字段、status字段
        UserBind userBind = baseMapper.selectOne(userBindQueryWrapper);
        userBind.setBindCode(bindCode);
        userBind.setStatus(UserBindEnum.BIND_OK.getStatus());
        baseMapper.updateById(userBind);
        //更新用户表的bind_code字段、bind_status字段、name字段、idCard字段
